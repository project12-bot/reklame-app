...
|
*/
$config['base_url'] = 'http://localhost/reklame-app/';
...
|
*/
$config['encryption_key'] = 'ubah_dengan_kunci_acak_anda_sendiri_123';
...
*/
$config['csrf_protection'] = FALSE; // set TRUE untuk produksi -- semua form sudah menyertakan token CSRF
